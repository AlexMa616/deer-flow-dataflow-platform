...
export const zhCN: Translations = {
  ...
  inputBox: {
    ...
    mode: "模式",
    flashMode: "快速",
    flashModeDescription: "更快响应，适合简单问答和轻量任务",
    reasoningMode: "思考",
    reasoningModeDescription: "先分析再行动，适合需要更稳妥处理的任务",
    proMode: "深度",
    proModeDescription: "加入计划和待办跟踪，适合多步骤任务",
    ultraMode: "超高",
    ultraModeDescription: "启用更强工作流和子代理协作，适合复杂任务",
    webSearch: "联网",
    webSearchOnDescription: "允许本次对话调用网页搜索和网页读取工具",
    webSearchOffDescription: "关闭网页搜索和网页读取工具，仅使用已有上下文",
    searchModels: "搜索模型...",
    surpriseMe: "小惊喜",
